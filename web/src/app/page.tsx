    ...
    <section className="relative pt-28 pb-32 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-6">
        <div className="flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-gray-800 text-xs text-gray-500 mb-10 tracking-wide uppercase">
          ...
          <h1 className="text-5xl md:text-[76px] font-extrabold tracking-[-0.035em] leading-[1.05] mb-8">
          ...
          <div className="flex gap-3 mb-20">
            <Link href="/explorer"
              className="group px-8 py-3.5 bg-white text-gray-950 text-sm font-semibold rounded-lg hover:bg-gray-100 transition-all shadow-lg shadow-white/5">
              Open Explorer
              <span className="inline-block ml-1.5 transition-transform group-hover:translate-x-0.5">&rarr;</span>
            </Link>
            <a href="#guide"
              className="px-8 py-3.5 border border-gray-700 text-sm font-medium text-gray-300 rounded-lg hover:border-gray-500 hover:text-white transition-all">
              Quick Start
            </a>
          </div>
    ...
    <section id="how" className="relative py-32">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <span className="text-xs font-semibold uppercase tracking-[0.2em] text-gray-500">How it works</span>
          <h2 className="text-3xl md:text-5xl font-bold text-white mt-4 tracking-tight">Three steps. Fully autonomous.</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
          {steps.map((s, i) => (
            <div key={s.num} className="relative p-10 group">
              {i < steps.length - 1 && (
        ...
        <div className="mt-16 flex items-center justify-center gap-3 text-sm text-gray-600 flex-wrap">
          <span className="px-3 py-1.5 rounded-lg border border-blue-800/30 bg-blue-500/5 text-blue-400">Employer Agent</span>
          <svg className="w-5 h-5 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
          <span className="px-3 py-1.5 rounded-lg border border-gray-700 bg-gray-800/50 text-gray-300">Monad (IntentPool)</span>
          <svg className="w-5 h-5 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
          <span className="px-3 py-1.5 rounded-lg border border-emerald-800/30 bg-emerald-500/5 text-emerald-400">Worker Agent</span>
          <svg className="w-5 h-5 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
          <span className="px-3 py-1.5 rounded-lg border border-purple-800/30 bg-purple-500/5 text-purple-400">IPFS + x.402</span>
        </div>
      </div>
    </section>
  );
...
function WhyDifferent() {
  return (
    <section className="py-28 border-t border-gray-800/40">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <span className="text-xs font-semibold uppercase tracking-[0.2em] text-gray-500">Why it&apos;s different</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto mb-20">
          <div className="rounded-2xl border border-gray-800/60 bg-gray-900/20 p-8">
          ...
          <div className="rounded-2xl border border-blue-800/30 bg-blue-500/[0.03] p-8">
    ...
    <section className="py-28 border-t border-gray-800/40">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          <div>
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-gray-500">Capabilities</span>
            <h2 className="text-3xl md:text-4xl font-bold text-white mt-3 tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-gray-800/30 rounded-2xl overflow-hidden">
          {items.map((item) => (
            <div key={item.title} className="bg-gray-950 p-8 hover:bg-gray-900/80 transition-colors group">
    ...
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative rounded-3xl overflow-hidden">
          ...
          <div className="relative p-12 md:p-16 flex flex-col md:flex-row items-start gap-12">
            ...
            <div className="w-full md:w-96 shrink-0">
              <div className="bg-black/60 border border-gray-800 rounded-2xl p-6 font-mono text-sm text-gray-400 shadow-2xl shadow-black/40">
...
function GettingStarted() {
  return (
    <section id="guide" className="py-28 border-t border-gray-800/40">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <span className="text-xs font-semibold uppercase tracking-[0.2em] text-gray-500">Quick Start</span>
          <h2 className="text-3xl md:text-4xl font-bold text-white mt-4 tracking-tight">Running in 60 seconds.</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          <div className="rounded-2xl border border-gray-800 bg-gray-900/30 p-8 hover:border-blue-800/40 transition-colors group">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 uppercase tracking-wider">Discover &amp; execute tasks</p>
              </div>
            </div>
...
python cli.py start`}</pre>
          ...
          <div className="rounded-2xl border border-gray-800 bg-gray-900/30 p-8 hover:border-emerald-800/40 transition-colors group">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 uppercase tracking-wider">Publish tasks &amp; verify results</p>
              </div>
            </div>
  ...
  return (
    <section className="py-24">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <Image src="/logo-white.png" alt="" width={56} height={56} className="mx-auto mb-8 opacity-40" />
    ...
    <footer className="border-t border-gray-800/40">
      <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-600">
        ...
        <div className="flex items-center gap-6">
          ...
          <span>Coordination for autonomous agents.</span>
        </div>
      </div>
    </footer>
  );
